        ...
        <div className="flex justify-between items-center px-6 py-4">
          <div className="flex items-center space-x-4">
            <div className="text-xl font-bold text-gray-800 ">
              <a href="/" className="text-blue-500 font-medium">SyrianaGo</a></div>
          </div>
          <div className="flex items-center space-x-4">
            <MessageBell />
        ...
        <aside className="w-64 bg-white  shadow-sm min-h-screen border-r border-gray-200 ">
          <div className="p-6 flex flex-col h-full">
            ...
            <div className="flex items-center space-x-3 mb-8">
              ...
              <div>
                <div className="font-medium text-gray-800 ">{user?.name || t("user.profile")}</div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white  rounded-lg shadow-sm border border-gray-200  p-6">
                  <div className="text-center">
                    <div className={`w-16 h-16 ${roleColors[role]} rounded-full flex items-center justify-center mx-auto mb-4`}>
                ...
                <div className="bg-white  rounded-lg shadow-sm border border-gray-200  p-6">
                  <h4 className="font-semibold mb-4 text-gray-800 ">{t("dashboard.quickActions")}</h4>
                      <button
                        className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-colors ${user?.twoFactorEnabled
